    ...
    <div class="container">
        ...
        <div class="search-bar">
            ...
            <select class="form-control mb-2" id="searchColor">
                ...
                <option value="w">
                    Branco
                    <img src="https://www.elfoman.com.br/wp-content/uploads/2018/10/white_mana.png" alt="Branco"
                        style="width: 20px; vertical-align: middle;">
                </option>
                <option value="u">
                    Azul
                    <img src="https://www.elfoman.com.br/wp-content/uploads/2018/10/blue_mana.png" alt="Azul"
                        style="width: 20px; vertical-align: middle;">
                </option>
                <option value="b">
                    Preto
                    <img src="https://www.elfoman.com.br/wp-content/uploads/2018/10/black_mana.png" alt="Preto"
                        style="width: 20px; vertical-align: middle;">
                </option>
                <option value="r">
                    Vermelho
                    <img src="https://www.elfoman.com.br/wp-content/uploads/2018/10/red_mana.png" alt="Vermelho"
                        style="width: 20px; vertical-align: middle;">
                </option>
                <option value="g">
                    Verde
                    <img src="https://www.elfoman.com.br/wp-content/uploads/2018/10/mana_green-e1659410632434.png"
                        alt="Verde" style="width: 20px; vertical-align: middle;">
                </option>
